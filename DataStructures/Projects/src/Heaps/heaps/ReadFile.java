...
public class ReadFile {
	...
	public static void parseLine(String inputline, ArrayBinaryTree tree){
	...
	public static ArrayBinaryTree readFile(String inputfilename) {
	...
	public static void readFile(ArrayList<String> inputfilename,ArrayBinaryTree tree) {
		Scanner rawinput= null;
